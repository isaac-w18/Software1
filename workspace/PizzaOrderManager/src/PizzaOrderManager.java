...
public final class PizzaOrderManager {
    ...
    private static void getPriceMap(String fileName,
        ...
        while (!in.atEOS()) {
            ...
            int price = Integer.parseInt(line.substring(commaIndex + 2));
    ...
    private static int getOneOrder(SimpleReader input,
        ...
        if (!input.atEOS()) {
            ...
            while (!sizePriceMap.hasKey(size)) {
                if (input.atEOS()) {
                    return price;
                }
                size = input.nextLine();
            ...
            while (!toppingPriceMap.hasKey(topping)) {
                if (input.atEOS()) {
                    return price;
                }
    ...
    public static void main(String[] args) {
        ...
        out.println(sizeMenu);
        out.println(toppingMenu);
        /*
